package com.example.mehrbod.gifcomplexobject.FrameGrabber.media;
...
import com.example.mehrbod.gifcomplexobject.FrameGrabber.gl.GLHelper;
	...
	public void getFrameAtTimeImpl(long frameTime) {
		...
		st.setOnFrameAvailableListener(new OnFrameAvailableListener() {
			...
			public void onFrameAvailable(SurfaceTexture surfaceTexture) {
				...
				mGLHelper.drawFrame(surfaceTexture, textureID);
